...
# amigos como pares clave-valor en un diccionario, y luego imprime
...
# Funciones Lambda: Escribe un programa que utilice una función lambda para
# ordenar una lista de tuplas (nombre, edad, altura) en orden ascendente
# por el nombre, luego por la edad y luego por la altura.
def lambda1():
